"""B4 column registry: extract 14 cols; hard gate 12 cols vs 123.

``ma_alignment`` / ``w_ma_alignment`` stay in extract/export but are soft
(TA-native MA5/MA10 regime; not ported from 123 ``ma_regime``).
"""
...
B4_SOFT_DAILY_FIELDS: List[str] = ["ma_alignment"]
